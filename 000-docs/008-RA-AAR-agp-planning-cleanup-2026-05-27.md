...
| C7 | Docs assumed AGP holds an Anthropic API key | `agp-5l8.8` | #26 | #29 | `154a000` | Corrected: the Claude sprite reuses the operator's Claude Code login session (CCSC posture); AGP holds no Anthropic API key at v0. |

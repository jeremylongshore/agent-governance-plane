...
- **BREAKING:** refactor(cli)!: extract the watcher agent out of AGP into bob-the-intendant (#128) (e790504)
...
- docs(pages): enable GitHub Pages (minimal theme, README as landing) + link it (c6ef2ca)

## [0.1.89] - 2026-06-25

### Changed

- docs(readme): comprehensive rewrite to current architecture (73e525a)
- chore(beads): close agp-g1h (AGP one-pager/operator-audit gist refreshed to v0.1.87) (6339d32)

## [0.1.88] - 2026-06-25

### Changed

- docs(aar): release report for v0.1.87 (on_behalf_of reservation + board verdict) (68a8c22)
- chore(beads): close agp-dxp.1 (on_behalf_of reserved + board verdict recorded, PR #116) (c187fc0)
...
- chore(review): adopt Greptile (.greptile/ config), replacing CodeRabbit + Gemini (#112) (58be30e)
...
- docs(adr): Topology C model-only egress-allowlist design (agp-3s4) (#109) (d6a4ab5)
...
- ci(dogfood): budget-scope the witnessed real-Claude run's default task (agp-0m3) (#107) (e40d200)
...
- feat(intendants): gated live Codex path (LiveCodexProcess) — provisional interception (agp-cln.2) (#99) (fc741aa)
...
- feat(verify): Ed25519 v0 verification backend that mints the verified identity URI (agp-z26.3) (#95) (37aae9a)
...
- feat(daemon): transactional outbox for at-least-once channel delivery (agp-4na.3) (#92) (d203f2f)
...
- fix(dogfood): add a hard timeout to the governed-run step + job (#78) (a0e33fd)
...
- docs(readme): refresh README/AGENTS/CLAUDE — real description, sprite→intendant, current status (#73) (64a4791)
...
- docs(substrate): flag CCSC secret-value guard for Epic-04 re-sync (f75f375)
- chore(beads): close Epic 05 (agp-oqh) + 4 children after PR #59 (8bb989e)

## [0.1.39] - 2026-06-03

### Added

- feat(epic05): internal Gateway protocol — Unix-socket transport, fail-closed (#59) (3ee2f65)

### Changed

- chore(beads): record Biome linter done; mutation skipped per decision (agp-e3b) (f80200d)
